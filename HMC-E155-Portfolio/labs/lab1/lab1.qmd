...
The source code for this project can be found in the associated Github repository here: put link here

## Block Diagram:
![Figure 1: Block Diagram](images/BlockDiagram.jpg)
...
## Schematic:
![Figure 2: Schematic](images/Schematic.jpg)
...
![Figure 3: Calculations](images/Calcualtions.jpg)
...
![Figure 4: Top Module Test Bench Waveforms](images/topTBWaves.png)

![Figure 5: Top Module Test Bench Terminal Report](images/topTBLog.png)
...
![Figure 6: SegmentDisp Test Bench Waveforms](images/SegmentDispTBWaves.png)

![Figure 7: SegmentDisp Test Bench Terminal Report](images/SegmentDispTBLog.png)
...
Got it 🙂 — you're getting PAR (Place & Route) failed in Lattice Radiant when trying to build the SystemVerilog code I gave you. This usually isn’t caused by the syntax itself but rather by one of these common issues:
The SB_HFOSC primitive isn’t recognized or isn’t enabled.
